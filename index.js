(function (exports, nop) {
  /**
   * createChain – automatically documented
   * @param {*} layers
   * @param {*} coreFn
   * @returns {*} 
   */
        ...
        capture = function (data) {
          ...
          if (index >= layers.length) {
            ...
            layers[index](
              data,
              /**
               * next – automatically documented
               * @param {*} data
               * @param {*} bubbleFn
               * @returns {*} 
               */
              function next(data, bubbleFn) {
              ...
              /**
               * cancel – automatically documented
               * @param {*} err
               * @param {*} data
               * @returns {*} 
               */
            ...
            errors.push(
              new Error("user error! A link in the layers was not a function"),
            );
            bubble(data);
          }
        };
